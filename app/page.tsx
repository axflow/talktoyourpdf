  ...
  return (
    <>
      ...
      <p className="mt-6">
        ...
        the added context from our document. If the document contains information that is publicly
        unavailable or time-sensitive, then you should see a large discrepancy between responses
        with and without this context.
      </p>
